              ...
              <View style={styles.inputContainer} key={index}>
                ...
                <View>
                  ...
                  <PhoneInput
                    ...
                    containerStyle={{ height: 35, width: "100%", marginTop: 2 }}
      ...
      >
        <Card disabled={true}>
          ...
          <View style={{ display: "flex", rowGap: 10, marginBottom: 10 }}>
            ...
            <Text style={styles.modalText}>
              4) Rates are charged in Thai Baht. Therefore, the amount shown on
              monthly statement in other currencies sent to you by the
